                        ...
                        <div class="filter-result-area">
                            ...
                            <div class="body-area">
                                <form action="#">
                                    ...
                                    <button class="filter-btn price-btn apply-btn"
                                    ...
                                    @foreach ($cats as $key => $cat)
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <a class="button d-inline-block pb-2 cat-anchor" href="#"
                                                    data-cat_id="{{ $cat->id }}" @if ($cat->id == request()->input('category_id')) style="color: #0056b3;" @endif>
                        ...
                        <div class="design-area">
                            ...
                            <div class="body-area">
                                <ul class="filter-list brand-list">
                                                ...
                                                <div class="check-box">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input brand-check" type="checkbox"
                                                            ...
                                                            {{ is_array(request()->input('brand_id')) && in_array($brand->id, request()->input('brand_id')) ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <button class="apply-btn filter-btn" type="button"
                                                style="width:100%;">{{ $langg->lang37 }}</button>
                                        </div>
                                        <div class="col-lg-6">
                                ...
                                <select name="fuel_type_id" id="selFuel">
                                    ...
                                    @foreach ($ftypes as $key => $ftype)
                                        <option value="{{ $ftype->id }}"
                                            {{ request()->input('fuel_type_id') == $ftype->id ? 'selected' : '' }}>
                                            {{ $ftype->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select name="transmission_type_id" id="selTransmission">
                                    ...
                                    @foreach ($ttypes as $key => $ttype)
                                        <option value="{{ $ttype->id }}"
                                            {{ request()->input('transmission_type_id') == $ttype->id ? 'selected' : '' }}>
                                            {{ $ttype->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select id="selCondition" name="condition_id">
                                    ...
                                    @foreach ($conditions as $key => $condition)
                                        <option value="{{ $condition->id }}"
                                            {{ request()->input('condition_id') == $condition->id ? 'selected' : '' }}>
                                ...
                                <li class="item-short-area">
                                    ...
                                    <select class="short-item sel-sort" name="sort">
                                        ...
                                        <option value="price_asc"
                                            {{ request()->input('sort') == 'price_asc' ? 'selected' : '' }}>
                                            {{ $langg->lang27 }}</option>
                                    </select>
                                </li>
                                                ...
                                                <div class="content">
                                                    ...
                                                    <ul class="top-meta">
                                                        ...
                                                        <li>
                                                            ...
                                                            {{ time_elapsed_string($car->created_at) }}
                                                        </li>
                                                    </ul>
                                                    <ul class="short-info">
                                                        <li class="north-west" title="Model Year">
                                                            <img src="{{ asset('assets/front/images/calender-icon.png') }}"
                                                                alt="">
                                                            <p>{{ $car->year }}</p>
                                                        </li>
                                                        <li class="north-west" title="Mileage">
                                                            <img src="{{ asset('assets/front/images/road-icon.png') }}"
                                                                alt="">
                                                            <p>{{ $car->mileage }}</p>
                                                        </li>
                                                        <li class="north-west" title="Top Speed (KMH)">
                                                            <img src="{{ asset('assets/front/images/transformar.png') }}"
                                                                alt="">
                                                            <p>{{ $car->top_speed }}</p>
                                                        </li>
                                                    </ul>
                                                    <div class="footer-area">
                                                        <div class="left-area">
                                                            @if (empty($car->sale_price))
                                                                <p class="price">
                                                                    {{ $car->currency_symbol }}
                                                                    {{ number_format($car->regular_price, 0, '', ',') }}
                                                                </p>
                                                            @else
                                                                <p class="price">
                                                                    {{ $car->currency_symbol }}
                                                                    {{ number_format($car->sale_price, 0, '', ',') }}
                                                                    <del>{{ $car->currency_symbol }}
                                                                        {{ number_format($car->regular_price, 0, '', ',') }}</del>
                                                                </p>
                                                            @endif
                                                        </div>
                                                        <div class="right-area">
