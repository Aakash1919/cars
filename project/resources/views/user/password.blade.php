                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('user.password.update') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ $langg->lang178 }} *</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="password" class="input-field" name="cpass"
                                            placeholder="{{ $langg->lang101 }} {{ $langg->lang178 }}" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ $langg->lang179 }} *</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="password" class="input-field" name="newpass"
                                            placeholder="{{ $langg->lang101 }} {{ $langg->lang179 }}" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ $langg->lang180 }} *</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="password" class="input-field" name="renewpass"
                                            placeholder="{{ $langg->lang180 }}" required="" value="">
                                    </div>
                                </div>
